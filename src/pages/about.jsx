    ...
    <>
      ...
      <Layout>
        ...
        <section className={styles.bio}>
          <p>
            I’m Cuban, born and raised in the countryside. Currently, I work as
            an Engineer Manager for The New York Times, focusing on their
            Cooking mobile app. Despite my profession, I only got my first
            computer at age 22 and my first cell phone when I was 24, right
            after arriving in the US. At present, I'm 35 years old.
          </p>
          <p>
            I've always believed the term "artist" is one of the grandest
            compliments one can give. Art, in its various forms, has fascinated
            me since childhood. What intrigues me most is its ability to evoke
            ...
            things, there are masters whose code leaves you in awe, while
            others, well...
          </p>
          <p>
          ...
          <p>
            If you're ever looking for a book recommendation, “The Little
            Prince” by Antoine de Saint-Exupery would be my top pick. And for a
